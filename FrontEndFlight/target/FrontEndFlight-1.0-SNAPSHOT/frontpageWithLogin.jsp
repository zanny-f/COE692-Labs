    ...
    <body>
        ...
        <div style="padding-left:16px">
            ...
            <form action="FrontEnd" method="post"> 
                ...
                <table>
                    <tr><th></th><th>destination</th><th>Flight Name </th><th>Schedule Request</th></tr>
                        ...
                        <td><%if (flight.isTobeSchedule()){%>
                            <input type="submit" value="Schedule"> 
                            <% }else {System.out.println("Not available for Scheduling");}%></td>
                              <%  }
                              }
